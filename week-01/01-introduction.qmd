...
abstract: |
 This is the first of a six part series of lectures as part of the data handling postgraduate module in Atlantic Technological University. 
...
-   We'll discuss how to make the most of your data.
...
::: columns
::: {.column width="40%"}
![](images/Ruth-Moran.jpg){.absolute right="65%" width="200"}
:::
...
-   `complete.cases()` returns `TRUE` if there are no missing valuees in a row
