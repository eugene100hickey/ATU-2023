...
- main function we'll use is `import()`
    ...
    - also works with **googlesheets**. Pass in web address that we can get from the *Share* section of  the googlesheet (we'll look at this oin this weeks worsheet later on)
...
- function `auth_setup()` to connect to your account

- `get_timeline_public(hashtag = "rstats", instance = "mastodon.social", limit = 200)` to get dataframe of [toots]{.underline}
