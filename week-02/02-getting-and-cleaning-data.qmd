...
```{r}
library(tabulizer)
organ_transplant <- "https://nhsbtdbe.blob.core.windows.net/umbraco-assets-corp/29388/weekly-statistics.pdf"
...
- `tidyquant` is my go-to for stock data
    ...
    - `td_get("my_stock_symbol")` returns actual stock market data.
...
- `get_timeline_public(hashtag = "eurovision", instance = "mastodon.social", limit = 200)` to get dataframe of [toots]{.underline}
...
- three step process
    ...
    - read in the whole web page (`html_read()`)
