...
Solution
========
Use `ncdc_stations(locationid = "FIPS:EI")$data`, then `ncdc(datasetid='GHCND',  stationid=ghcnd, datatypeid='PRCP', startdate = start_date, enddate = end_date, limit=500, add_units = TRUE)$data`.
