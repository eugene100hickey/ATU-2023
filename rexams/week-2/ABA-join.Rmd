...
brain_data <- read_rds("https://github.com/eugene100hickey/ATU-2023/blob/main/rexams/data/brain-area-codes?raw=true")
...
z1 <- gene_data |> 
  left_join(brain_data, join_by(structure == brain_code)) |> 
